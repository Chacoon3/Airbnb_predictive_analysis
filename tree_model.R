...
full_tree=tree(y_train_hbr ~ accommodates + availability_30 + 
                 ...
                 state+weekly_price+TV+Internet+Heating+Kitchen+Essentials+
                 +Shampoo+Hangers+Washer+amentities_number+email+phone+google+reviews+
